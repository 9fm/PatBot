        ...
        const embed = new EmbedBuilder()
            ...
            .addFields(
                ...
                },
                {
                    ...
                    value: random.element(["DJ Płodny jest najpotezniejsza istota na świecie", "Nie posiadam rodziny", "DJ Płodny urodził się w roku 1842", "W filipinach można kupić spaghetti w mcdonaldzie", "90% programistów poddaje się tuż przed tym jak mieli w końcu w pełni zautomatyzować rzecz której zrobienie recznie zajmuje 5 sekund", "JavaScript jest najlepszym językiem programowania", "Zdecydowana większość populacji żab nie zna języka włoskiego", ":3", "W 2019 roku 100% ludzi którzy zginęli w wypadkach samochodowych umarło", "Reakcje jądrowe to przemiany jąder atomowych wywołane ich oddziaływaniem wzajemnym bądź też ich oddziaływaniem z cząstkami elementarnymi", "Gacie są po to żeby w nie srać", "Urządzenia elektroniczne z reguły działają lepiej gdy są podłączone do prądu", "Księga Unity jest najwazniejsza księga na świecie", "Zesrałem się w gacie", "Twoja mama to gej"]),
                    inline: true,
                },
            );
